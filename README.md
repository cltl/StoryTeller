...
Function
     vu.cltl.storyteller.json.JsonQueryHierarchy.getJsonHierarchyFromKnowledgeStore
Parameter
     --ks-service               ip address with the port of the KnowledgeStore service
     --ks-user                  (optional) if the KnowledgeStore is user protected a username is required
     --ks-passw                 (optional) if the KnowledgeStore is user protected a psswords is required
Return
    output# StoryTeller
          ...
          Parameter
               ...
               --ks-passw                 (optional) if the KnowledgeStore is user protected a psswords is required
          Return
              output stream with the entity and concept hierarchy in JSON format
          ...
          Parameter
               ...
               --ks-user                  (optional) if the KnowledgeStore is user protected a username is required
               --ks-passw                 (optional) if the KnowledgeStore is user protected a psswords is required
               --eso                      path to the ESO file in OWL, e.g. ESO_V2_Final.owl
          Return
              output stream with the entity and concept hierarchy in JSON format
          ...
          Parameter
               ...
               --ks-user                  (optional) if the KnowledgeStore is user protected a username is required
               --ks-passw                 (optional) if the KnowledgeStore is user protected a psswords is required
               --eurovoc-label            path to the eurovoc label file, e.g. mapping_eurovoc_skos.label.concept.gz
               --eurovoc-core             path to the eurovoc core file, e.g. eurovoc_in_skos_core_concepts.rdf.gz
          Return
               output stream with the entity and concept hierarchy in JSON format
