...
import vu.cltl.storyteller.objects.Triple;
import vu.cltl.storyteller.trig.TrigUtil;
import vu.cltl.storyteller.util.RoleLabels;
...
*/
    ...
    static JSONObject getActorsJSONObjectFromInstanceStatement (ArrayList<Statement> statements) throws JSONException {
        ...
        return getActorsJSONObjectFromInstanceStatement(statements, emptyList);
    }
...
/*                        if (!tooTinyValue(getValue(value))) {
        ...
        for (int i = 0; i < eventTriples.size(); i++) {
            ...
            actor = JsonStoryUtil.normalizeSourceValue(actor);
